...
export class ContactComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.pageService.getPage('contact').subscribe({
      next: (page) => {
        try {
          this.applyMeta(page);
  ...
  submit(): void {
    ...
    this.formsService.submitContact(this.form.value).subscribe({
      next: () => {
        this.statusType = 'success';
        this.statusMessage = 'Thanks! We will respond within one business day.';
        this.form.reset();
      },
